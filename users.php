...
<div class="container">
        <h2 class="text-center pt-4" style="color : white;">Our Users</h2>
        <br>
            <div class="row">
                <div class="col">
                ...
                ?>
                    <tr style="color : white;">
                        ...
                        <td><a href="userdetails.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn" style="background-color : greenyellow;">Transfer money</button></a></td> 
                    </tr>
                <?php
                    }
                ?>
